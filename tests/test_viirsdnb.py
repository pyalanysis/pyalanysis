...
import shutil
import tempfile
from typing import cast, Generator, Tuple, Callable, Iterator, Any
...
class TestViirsDnbMonthlyFile:
    ...
    def _get_viirs_decorator(fun) -> Callable[[object], None]:
    ...
    def test_get_viirs_dnb_monthly_file_file_exists(self):
        ...
        url, file = get_viirs_dnb_monthly_fn(self._loc, self._year, self._month, self._light_correction)
    ...
    def test_no_username(self):
        with pytest.raises(Exception) as excinfo:
            get_viirs_dnb_monthly_file(self._loc, self._year, self._month, self._light_correction)
